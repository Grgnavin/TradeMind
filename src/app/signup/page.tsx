...
import { Mail, Lock, User, ArrowRight, TrendingUp, ShieldCheck } from 'lucide-react';
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-80px)] p-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold italic">Master Your Edge</h1>
          <p className="text-zinc-500 mt-2">Join 10,000+ traders using TradeMind AI</p>
        </div>
        ...
        <Card variant="glass" className="p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-gold/5 border border-gold/10 mt-2">
              <ShieldCheck className="text-gold" size={24} />
              <p className="text-[10px] text-zinc-400 leading-tight">
                Your data is encrypted. We never share your trading strategy or personal details with third parties.
              </p>
            </div>

            <Button variant="gold" size="lg" className="w-full mt-2" type="submit" disabled={isLoading}>
              {isLoading ? 'Creating Account...' : 'Create Account'} <ArrowRight className="ml-2" size={20} />
            </Button>
          </form>
